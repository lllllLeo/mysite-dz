...
//	private transient final Log LOGGER = LogFactory.getLog( this.getClass() );
	...
	public void handlerException(HttpServletRequest request, HttpServletResponse response, Exception e) throws
...
//		System.out.println(errors);
		...
		// 2. 요청 구분
		// 만약 JSON 요청인 경우, request header Accept  application/json
		// 만약 HTML 요청인 경우, request header Accept  text/html
